...
maindir = '/Users/leila/Documents/NSFEduSupport/test/stream/'

# Step 1 Users/leila/Documents/NSFEduSupport/database/
file_1 = 'not_in_preferred_stream_baseline.csv'
file_2 = '/Users/leila/Documents/NSFEduSupport/github/data-review-tools/prefered_stream_baseline/stream_review_baseline.csv'
...
f12.to_csv(maindir + 'combined_lists.csv', index=False)
...
f123.to_csv(maindir + 'to_verify.csv', index=False)