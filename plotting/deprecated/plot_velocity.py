...
@brief: This script is used create plots for VELPT variable by deployment and preferred delivery method.
The user has the option to plot a specific time range and the preferred data delivery method.
"""
