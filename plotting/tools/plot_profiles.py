...
if __name__ == '__main__':
    ...
    start_time = dt.datetime(2016, 6, 1, 0, 0, 0)  # optional, set to None if plotting all data
    end_time = dt.datetime(2017, 10, 1, 0, 0, 0)  # optional, set to None if plotting all data
